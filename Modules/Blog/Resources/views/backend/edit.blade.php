...
@section('head')
    <title>Dashboard | Editer un Article</title>
...
@section('body')
    <section class="_header">
        <div class="container-fluid">
            <div class="row">
                <div class="col-sm-4">
                    <div class="title">Editer un Article <i class="ion-clipboard"></i> </div>
                </div>
    ...
    <section class="dashboard">
        <div class="container-fluid">
            ...
            {!! Form::model($post, ['method' => 'PATCH', 'route' => ['admin.blog.update', $post->id], 'class' => '_form' ]) !!}
                ...
                <div class="row">
                    <div class="col-sm-8">
                        ...
                        <div class="form-group">
                            ...
                            {!! Form::textarea('excerpt', $post->excerpt, [
                                'class' => 'form-control input-lg',
                                'rows' => 3
                            ]) !!}
                        </div>
                        ...
                        <div class="form-group mt-20">
                            {!! Form::label('content', 'Contenu du blog') !!}
