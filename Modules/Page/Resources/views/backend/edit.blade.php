...
@section('body')
    <section class="_header">
        <div class="container-fluid">
            <div class="row">
                <div class="col-sm-4">
                    <div class="title">Editer une Page <i class="ion-clipboard"></i> </div>
                </div>
    ...
    <section class="dashboard">
        <div class="container-fluid">
            ...
            {!! Form::model($page, ['method' => 'PATCH', 'route' => ['admin.pages.update', $page->id], 'class' => '_form' ]) !!}
                ...
                <div class="row">
                    ...
                    <div class="col-sm-4">
                        ...
                        <div class="form-group">
                            ...
                            ], $page->type, ['class' => 'form-control input-lg']) !!}
                        </div>
