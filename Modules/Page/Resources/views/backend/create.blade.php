...
@section('body')
    <section class="_header">
        <div class="container-fluid">
            <div class="row">
                <div class="col-sm-4">
                    <div class="title">Nouvelle Page <i class="ion-clipboard"></i> </div>
                </div>

                <div class="col-sm-8">
                    <div class="buttons text-right">
                        <a href="{{ route('admin.pages') }}" class="btn btn-grey btn-md bold">
                    ...
                    <div class="col-sm-8">
                        ...
                        <div class="form-group">
                            ...
                            {!! Form::textarea('excerpt', old('excerpt'), [
                                'class' => 'form-control input-lg',
                                'rows'  => 3,
                                'placeholder' => 'Extrait de la page'
                            ]) !!}
                        </div>
                    ...
                    <div class="col-sm-4">
                        ...
                        <div class="form-group">
                            ...
                            {!! Form::select('type', [
                                ...
                                'bienvenue' => 'Mot du président',
                                'presentation' => 'Présentation',
                                'apropos' => 'Qui sommes nous ?',
                                'organisation' => 'Organisation',
                                'membres' => 'Membres',
                                'statuts' => 'Statuts & reglement',
                            ], old('type'), ['class' => 'form-control input-lg']) !!}
                        </div>

                        <div class="mt-20">
                            {!! Form::label('image', 'Image') !!}

                            <input type="hidden" id='profile' name='image' value="{{ old('image') }}" >
