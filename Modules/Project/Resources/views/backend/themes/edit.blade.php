...
@section('body')
            ...
            <div class="row">
                ...
                <div class="col-sm-8">
                    <div class="buttons text-right">
                        <a href="{{ route('admin.themes') }}" class="btn btn-grey btn-md bold">
    ...
    <section class="dashboard">
        <div class="container-fluid">
            ...
            {!! Form::model($theme, ['method' => 'PUT', 'route' => ['admin.themes.update', $theme->id], 'class' => '_form' ]) !!}
                    ...
                    <div class="col-sm-4">
                        <div class="form-group">
                            ...
                            <select name="parent_id" class="form-control input-lg">
                                <option value="" {{ $theme->parent_id == '' ? 'selected' : ''}}>Aucun</option>
                                @foreach($themes as $item)
                                     <option
                                         value="{{ $item->id }}"
                                         {{ $item->id == $theme->parent_id ? 'selected' : ''}}
                                     >
                                         {{ $item->name }}
                                     </option>
                                @endforeach
