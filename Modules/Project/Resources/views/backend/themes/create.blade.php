...
@section('head')
    <title>Dashboard | Nouveau Thème</title>
...
@section('body')
    <section class="_header">
        <div class="container-fluid">
            <div class="row">
                <div class="col-sm-4">
                    <div class="title">Nouveau Thème <i class="ion-grid"></i> </div>
                </div>
                ...
                <div class="row">
                    ...
                    <div class="col-sm-4">
                        <div class="form-group">
                            ...
                            <select name="parent_id" id="categories" class="form-control input-lg">
