...
@section('head')
    <title>Dashboard | Editer un Partenaire</title>
...
@section('body')
    <section class="_header">
        <div class="container-fluid">
            <div class="row">
                <div class="col-sm-4">
                    <div class="title">Editer un Partenaire <i class="ion-network"></i> </div>
                </div>
    ...
    <section class="dashboard">
        <div class="container-fluid">
            ...
            {!! Form::model($partner, ['method' => 'PUT', 'route' => ['admin.partners.update', $partner->id], 'class' => '_form' ]) !!}
                ...
                <div class="row">
                    ...
                    <div class="col-sm-8">
                        ...
                        <div class="form-group mt-20">
                            ...
                            {!! Form::textarea('description', $partner->description, [
                                'class' => 'form-control input-lg',
                                'rows' => 4,
